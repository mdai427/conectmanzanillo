...
export default function Navbar() {
  ...
  const canVerifyCompanies = hasPermission('company.verify')
  const adminHref = canManagePlatform ? '/admin' : '/admin/verificaciones'
