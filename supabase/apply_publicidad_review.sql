-- Faro Portuario · columnas de revisión + métricas de publicidad (extracto de 016)
-- Depende de: public.publicidad_campanas (creada en apply_directorio_publicidad.sql)
